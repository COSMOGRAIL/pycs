...
for subname in ["pycs_tdc1_d3cs-vanilla-dou-full", "pycs_tdc1_spl-vanilla-dou-full", "pycs_tdc1_sdi-vanilla-dou-full"]:
	subhist(db, subname)
...
plt.legend()
#plt.show()
plt.savefig("hist_chi2_rung4.pdf")
