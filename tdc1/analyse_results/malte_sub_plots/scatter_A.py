...
def subplot(db, subname, subi):
	...
	plt.plot(truetds, aterms, "o", color=colors[subi], markeredgecolor="none", markeredgewidth=0, markersize=4, alpha=0.1, zorder=-10)
...
plt.ylabel(r"$\frac{\widetilde{\Delta t_i} - \Delta t_i}{\Delta t_i}$", fontsize=26)
