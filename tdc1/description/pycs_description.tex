...
\end{enumerate}
These simplifications remove any form of ``safety margin'' from the free-knot spline technique as applied to individual real datasets. The resulting TDC1 error estimates are certainly not pessimistic. The entire \emph{spl} analysis takes about 5 CPU-minutes for an average TDC1 pair.  
