...
commentlist = ["D3CS combi", "VB estimations", "doubtless, plausibles, multimodal estimates", "full range"]
...
estimates = [est for est in estimates if est.confidence in [1,2,3]] #doubtless only
